...
Mendesain arsitektur penyimpanan data yang efisien
Mengintegrasikan sistem data dengan aplikasi pihak ketiga atau alat analitik
Chord Transcription AI Project:
Melakukan research untuk pengembangan project audio classification
Membersihkan dan memproses data audio
Melakukan eksperimen dengan model audio classification
Mengembangkan model audio classification
...
Terbiasa menggunakan deep learning framework (PyTorch/TensorFlow) dalam pengembangan model machine learning
Familiar dengan tools visualisasi data (Tableu, Looker Studio, Power BI)
Memiliki pemahaman dasar tentang piano (optional)
