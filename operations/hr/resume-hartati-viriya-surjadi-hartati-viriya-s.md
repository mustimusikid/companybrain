...
Applied **SQL (PostgreSQL), Python (Pandas, NumPy)**, and** data visualization** (Matplotlib, Seaborn, Google Data Studio) in multiple real-world projects.
Built and deployed classification & regression models using **Machine learning and advanced preprocessing techniques.**
Completed end-to-end projects (Mini, Wrangler, Alchemist, Maestro, Conqueror) achieving up to 100% project scores for technical execution and soft skills.
Developed strong collaboration, presentation, and professional branding skills through continuous peer reviews and stakeholder engagement.
       January 2024 – March 2024
Mastered **end-to-end mobile app development** using Flutter and Dart, from **UI/UX design** to **backend integration**.
Built **scalable, production-ready apps** with **Bloc state management**, **advanced routing**, **HTTP APIs**, and **Firebase services** (Authentication, Database, Cloud Messaging).
Applied **clean code principles** and **test-driven development (TDD)** for maintainable and reliable software.
...
Designed and built containerized microservices for OCR, signature verification, and liveness check using modern frameworks. Integrated the services into the underwriting workflow to automate KYC validation.
Reduced manual KYC validation workload by automating document and identity verification processes through AI based validation systems.
...
Built a **Marketing Lead Scoring System** using classification algorithms to rank high potential leads, improving campaign targeting and conversion efficiency.
Conducted **RFM (Recency, Frequency, Monetary) scoring** to segment existing customers, enabling retention strategies, upselling opportunities, and personalized marketing.
Integrated the model into a web based CRM dashboard using Flask to support **data driven decision making**.
Enabled the marketing team to monitor conversion likelihood, improve campaign targeting, and increase engagement efficiency.
...
*
Collaborated in a team of 4 to develop a prototype system that automates 5S audits (Seiri, Seiton, Seiso) using object detection models (YOLOv10/11).
Built a web based platform that allows image/video uploads to detect workplace compliance violations, visualize audit scores, and suggest corrective actions.
Conducted comparative model analysis to select optimal YOLO architectures for each 5S category, implemented backend using Flask and model training on Google Colab
Used a custom labeled dataset from our campus lab due to client data privacy constraints, maintained secure, local data handling throughout.
Delivered a functional prototype that reduces manual audit labor, improves consistency, and lays the groundwork for future real-time 5S compliance systems.

Developed a real-time facial emotion recognition tool using a CNN trained on the FER2013 dataset. Accurately classifies 7 emotions from webcam input.
Built and trained a custom deep CNN with data augmentation using TensorFlow/Keras.
...
HSK 2, (Hanban Confucius Institute) Score: 197/200
HSK 4, (Hanban Confucius Institute) Score: 328/400
