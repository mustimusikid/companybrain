...
Jika Anda memiliki pertanyaan mengenai kebijakan kami, silakan hubungi whatspp musti musik di +6283199414911
...
Pembelajaran dilakukan online melalui zoom
...
Untuk opsi 2 Jika pemberitahuan diberikan minimal 24 jam sebelumnya oleh individu, mentor akan menawarkan waktu pelajaran pengganti yang sesuai kepada murid. Namun, tidak akan ada jadwal pengganti jika waktu baru tersebut tidak cocok.
Jika murid tidak dapat menghadiri pelajaran, harap beritahu Musti Musik sesegera mungkin, melalui whatsapp Musti Musik +6283199414911. Informasi ketidakhadiran akan diteruskan kepada mentor yang bersangkutan – Anda juga dipersilakan menghubungi mentor secara langsung jika Anda memilih untuk melakukannya. Jika pemberitahuan ketidakhadiran diberikan kurang dari 24 jam sebelum pelajaran, tidak akan ada pelajaran pengganti dan pelajaran tersebut dianggap hangus.
Anda atau Mentor Musti Musik akan mengatur pelajaran pengganti pada waktu yang disepakati bersama. Anda juga dapat mengganti pelajaran dalam bentuk tambahan waktu 45 menit pada pelajaran berikutnya atau tambahan waktu 45 menit pada dua pelajaran berikutnya.
...
**Untuk pertanyaan atau kekhawatiran apa pun, silakan hubungi whatsapp Musti Musik +6283199414911 **
![image20.png](Syarat dan Ketentuan 1on1 Musti Musik_images/image20.png)

Content schedule
![image30.jpg](Syarat dan Ketentuan 1on1 Musti Musik_images/image30.jpg)
CONTENT SCHEDULE

| Release date | Title | Type | Description | Platform | Creator | Deadline | Status |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Date | Product demo |  | An entertaining 30 second video that introduces the product in a fun and engaging way | YouTube | Person | Date |  |
| Date | Content 2 |  | Add description | Add platform | Person | Date |  |
| Date | Content 3 |  | Add description | Add platform | Person | Date |  |
| Date | Content 4 |  | Add description | Add platform | Person | Date |  |
| Date | Content 5 |  | Add description | Add platform | Person | Date |  |
| Date | Content 6 |  | Add description | Add platform | Person | Date |  |

Example 1: product demo details
![image36.jpg](Syarat dan Ketentuan 1on1 Musti Musik_images/image36.jpg)
...
Content 2
![image7.jpg](Syarat dan Ketentuan 1on1 Musti Musik_images/image7.jpg)
CONTENT 2
...
| --- | --- |
| Follower growth | # or NA |
| Social engagement rate | # or NA |
| Click-through rate | # or NA |
| Lead generation rate | # or NA |
